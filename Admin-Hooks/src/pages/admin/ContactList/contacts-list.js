...
import {
  getTeams as onGetTeams,
  updateTeams as onUpdateTeam
} from "store/admin/team/actions";
  ...
  const validation = useFormik({
    ...
    onSubmit: values => {
      if (isEdit) {
        ...
        // update user
        dispatch(onUpdateTeam(updateUser));
        dispatch(onGetTeams());
...
export default withRouter(TeamManager);
